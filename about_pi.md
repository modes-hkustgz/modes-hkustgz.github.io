...
- **Guangzhou Municipal Science and Technology Bureau: Young Scientists Fund**, Mechanism Design and Optimization for Mobility-as-a-Service, PI.
- **NSFC: Young Scientists Fund**, Multi-perspective Game-theoretical Studies for Decentralized Truck Platooning Systems, PI, *completed*.
- **Guangzhou Municipal Science and Technology Bureau: 2023 Guangzhou–HKUST(GZ) Joint Funding Scheme (Industry)**, Autonomous Traffic Efficiency and Safety under Perception Uncertainty: The Integrated Analysis and Countermeasures, PI, *completed*.
- **Dongfang Electric Corporation**, Validation Services for Precision Assessment of Surplus Decision-Making Training under Human–Machine Integration, co-PI.
- **NSFC: General Program**, Research on Optimization Problems in Container Terminal Gate Traffic Management and Congestion Mitigation, co-I.
- **Chief Executive’s Policy Unit, HKSAR Government: Strategic Public Policy Research Funding Scheme (SPPR)**, Development Strategies for an Advanced Air Mobility Network in the Guangdong–Hong Kong–Macao Greater Bay Area, co-I.
- **Guangzhou Municipal Science and Technology Bureau: Guangzhou Municipal Key Laboratory Program**, Guangzhou Finance Technology Frontier Municipal Key Laboratory, co-I, *completed*.
